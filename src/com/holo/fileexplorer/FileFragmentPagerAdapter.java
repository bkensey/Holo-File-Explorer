 ...
 * complete}
 */
public class FileFragmentPagerAdapter extends PagerAdapter {
	...
	private String[] numberSpelling;
	

	public FileFragmentPagerAdapter(Context context, FragmentManager fm) {
		mFragmentManager = fm;
		numberSpelling = context.getResources().getStringArray(R.array.numbers_array);
	}
	 ...
	 */
	public FileListFragment getFragment(ViewGroup container, int position) {
		String name = makeFragmentName(container.getId(), position);
		FileListFragment fragment = (FileListFragment) mFragmentManager.findFragmentByTag(name);
		return fragment;
	}
    ...
    public CharSequence getPageTitle (int position) {
		return "TAB " + numberSpelling[position];
    }
